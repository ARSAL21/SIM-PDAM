...
<div x-data="{ showPassword: false, isLoading: false }" class="space-y-6">
    ...
    <form method="POST" action="{{ route('login') }}" class="space-y-5" @submit="isLoading = true">
        ...
        <!-- Password -->
        <div class="animate-fade-up opacity-0 delay-200" x-data="{ show: false }">
            ...
            <div class="relative group">
                ...
                <input id="password" name="password" :type="show ? 'text' : 'password'" required
                       ...
                       placeholder="········">
                <button type="button" @click="show = !show" class="absolute inset-y-0 right-0 pr-3 flex items-center text-[#5A7080] hover:text-[#1AACB4] transition">
